            ...
            <div class="col-lg-8 col-12 mb-50">
                ...
                <div class="post-block-wrapper">
                    ...
                    <div class="head education-head">
                        <!-- Title -->
                        <h4 class="title"> @if(session()->get('language') == 'bangla') ফিচার্ড পোস্ট @else Featured post
                            @endif </h4>
                                                ...
                                                <div class="row d-flex jusified-content">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                        <span class="cat-links"><a href=""
                                                                class="text-danger">@if(session()->get('language') ==
                                                                'bangla') {{ $post->category->name_ban }} @else
                                                                {{ $post->category->name_en }} @endif</a></span><br>
                                                        <strong class="font-weight-bold">
                                                            <a href="{{ route('home.product.show',$post->slug_en) }}">@if(session()->get('language') == 'bangla')
                                                                {{ $post->name_ban }} @else {{ $post->name_en }}
                                                                @endif</a>
                                                        </strong>
                                                        <div class="meta fix mt-2">
                                                            <p>
                                                                @if(session()->get('language') == 'bangla')
                                                                {{ Str::limit($post->short_description_ban, 150, $end='...') }}
                                                                @else
